 ...
 */
public class RouletteV1UnsafeDrivingTest {
    ...
    @Test
    @TestAuthor(githubId = {"UnsafeDriving", "Manamiz"})
    public void theClientShouldYieldExceptionIfStoreEmpty() throws IOException {
        try {
        ...
        fail("Not yield exception and store is emty.");
